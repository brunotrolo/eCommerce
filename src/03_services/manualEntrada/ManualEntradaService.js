      ...
      actions: {
        addEntry: {
          ...
          params: {
            ...
            cfop: { type: 'string', required: false }
          },
  ...
  function listEntries(params) {
    ...
    for (var i = 0; i < rows.length && i < limit; i++) {
      ...
      entries.push({
        ...
        aliquotaIcms: parseFloat(r.ALIQUOTA_ICMS) || 0,
        valorIcmsItem: parseFloat(r.VALOR_ICMS_ITEM) || 0,
        status: r.STATUS || '',
        dataEntrada: r.DATA_ENTRADA || '',
        tipoMovimentacao: r.TIPO_MOVIMENTACAO || '',
        logId: r.LOG_ID || '',
        valorDescontoItem: parseFloat(r.VALOR_DESCONTO_ITEM) || 0,
